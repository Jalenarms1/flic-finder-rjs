            ...
            <Modal.Body className="bg-dark">
              <div className="w-100 d-flex justify-content-center">
                <div className="card const-shadow m-1" style={{width: '22rem'}}>
                    <img src={randomTitle.Poster} className="card-img-top" alt="..." style={{height: '22rem'}}/>
                    <div className="card-body card-body-pos bg-dark">
                        <div className="wrap-movie-info text-light">
                          <h5 className="card-title">{randomTitle.Title}</h5>
                          <p className="card-text">Directed by: {randomTitle.Director}</p>
                          <p>{randomTitle.Plot}</p>
                        </div>
                    </div>
                    <div className="card-footer">
                      <a className="btn btn-sm btn-outline-dark" href={`https://www.imdb.com/title/${randomTitle.imdbID}`} rel="noreferrer" target="_blank">View on IMDb</a>
                    </div>
                </div>
